...
- `specs/*.md` - Executable spec files for each task (this is what Ralph runs)
...
> **Templates:** See `templates/SPEC-template.md`
...
> Without Playwright, Ralph's test loop won't work!
